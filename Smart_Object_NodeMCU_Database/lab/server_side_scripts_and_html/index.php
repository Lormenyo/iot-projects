                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <!-- <button class="au-btn au-btn-icon au-btn--blue" type="button" data-toggle="modal" data-target="#exampleModal">
                                        <i class="zmdi zmdi-plus"></i>add item</button>
                                    <button class="au-btn au-btn-icon au-btn--blue" type="button" data-toggle="modal" data-target="#deleteModal">
                                        <i class="zmdi zmdi-minus"></i>Remove item</button>
                                    <button class="au-btn au-btn-icon au-btn--blue" type="button" data-toggle="modal" data-target="#updateModal">
                        ...
                        <div class="row m-t-25">
                            ...
                            // Run the query
                            $q = mysqli_query($con, "select * from `smart_object`
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h2 class="title-1 m-b-25">Sensor/Actuator Readings</h2>
                                    <div class="table-responsive table--no-card m-b-40">
                                        <table class="table table-borderless table-striped table-earning">
                                            ...
                                            <tbody>
                                                ...
                                                // Run the query
                                                $q = mysqli_query($con, "select * from `smart_object` ORDER BY  DataID DESC LIMIT  10");
